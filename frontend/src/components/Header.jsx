...
export default function Header({ onScrollToSection }) {
	...
	return (
		<header className="sticky top-0 z-[9999] flex items-center justify-between px-4 md:px-16 py-4 md:py-7 bg-black/70 backdrop-blur-lg text-white border-b border-white/10">
			<div
			...
			<nav className={`flex-col md:flex-row flex items-center gap-4 md:gap-8 absolute md:static top-full left-0 w-full md:w-auto bg-black/90 md:bg-transparent px-4 py-4 md:p-0 transition-all ${mobileMenuOpen ? "flex" : "hidden"} md:flex`}>
				<button
					type="button"
